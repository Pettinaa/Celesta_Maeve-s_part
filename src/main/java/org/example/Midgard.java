...
AudioClip bgm;
    ...
    public void init() {
        ...
        sheet = loadImage("Images/Midgard/spritesheet_princess.png");
        background = loadImage("Images/Midgard/background_human.png");
        background2 = loadImage("Images/Midgard/background_human2.png");
        for (int i = 0; i < 3; i++) {
...
//        drawPlant();
    ...
    //cat
    public void initNPC() {
        NPCWizard = loadImage("Images/Midgard/Wizard.png");
        Princess_talk = loadImage("Images/Midgard/Princess_talk.png");
        Wizard_talk = loadImage("Images/Midgard/Wizard_talk.png");
        Cat_talk = loadImage("Images/Midgard/cat_talk.png");
    ...
    public void initPlant(){
        humanTree = loadImage("Images/Midgard/HumanTree.png");
        humanBranches = loadImage("Images/Midgard/HumanBranches.png");
        humanStone = loadImage("Images/Midgard/HumanStone.png");
        humanBird = loadImage("Images/Midgard/HumanBird.png");
        humanChickenSheet = loadImage("Images/Midgard/HumanChickenSheet.png");
        humanFarm = loadImage("Images/Midgard/HumanLand.png");
        humanStump = loadImage("Images/Midgard/HumanStump.png");
    ...
    public void drawMisiion(){
        mission = loadImage("Images/Midgard/mission.png");
    ...
    public void initCat(){
        ...
        catX = 0;
        catY = 0;
        sheet_cat = loadImage("Images/Midgard/spritesheet_cat.png");
        for(int iy = 0; iy < 3; iy++){
            for(int ix = 0; ix < 4; ix++){
                cat[iy*4 + ix] = subImage(sheet_cat, ix*16, iy*16, 16, 16);
            }
        }
        catFront[0] = loadImage("Images/Midgard/cat_front_right.png");
        catFront[1] = loadImage("Images/Midgard/cat_front_left.png");
        catBack[0] = loadImage("Images/Midgard/cat_back_right.png");
        catBack[1] = loadImage("Images/Midgard/cat_back_left.png");
    }
